...
### Step 2 Create an RStudio Package Project for this folder. 

See the description here:

  https://support.rstudio.com/hc/en-us/articles/200486488-Developing-Packages-with-RStudio

### Step 3 Add data sets 

If you want to distribute the data sets used in your problem set directly with your problem sets, copy those data sets into the subfolder:

   		/inst/ps/problemset_name/materials/

### Step 4 update DESCRIPTION and README.MD
...
### Step 7: Create a Github account and upload package.
